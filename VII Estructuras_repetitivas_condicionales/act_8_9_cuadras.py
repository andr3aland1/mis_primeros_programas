...
dias = int(input("Ingrese la cantidad de días que caminó con su perro: "))

while dias != contador:
    contador += 1
    cuadras = int(input(f"Ingrese la cantidad de cuadras que caminó el día {contador}: "))
